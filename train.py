...
#-model conv -loadmodel ./CSE_Wiki.pickle -margin 0.6 -batchsize 256 -LW 1e-06 -LC 0.0 -dropout 0.1
...
parser.add_argument("-margin", help="Margin in objective function", type=float, default=0.6)
...
parser.add_argument("-epochs", help="Number of epochs in training", type=int, default=0)
...
if params.mode == "ppdb":
    d = utils.get_data("../data/ppdb-xl-phrasal-preprocessed.txt")
    random.shuffle(d)
